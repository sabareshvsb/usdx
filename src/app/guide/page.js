...
export default function Guide() {
  return (
    <main className="guide-shell">
      <header className="guide-nav glass-panel"><Link href="/" className="guide-brand"><span>U</span> USDX</Link><Link href="/" className="guide-back">← Back to landing</Link></header>
