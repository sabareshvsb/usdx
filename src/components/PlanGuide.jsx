    ...
    <main className="guide-shell">
      ...
      <section className="plan-hero">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <a className="mt-4 inline-flex items-center gap-3 rounded-[10px] border border-cyan-300/40 px-4 py-3 text-xs font-semibold text-cyan-300 transition hover:-translate-y-0.5 hover:bg-cyan-300/10" href={plan.pdf} download={plan.pdfName}>↓ Download plan instructions <span className="font-mono text-[10px] tracking-widest text-slate-400">.PDF</span></a>
        </div>
      </section>
