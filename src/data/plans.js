...
export const plans = {
  ...
  5000: { slug: "5000", price: "$5,000", name: "Professional Compounding Plan", horizon: 36, summary: "A multi-level ROI and affiliate plan with structured deployment across five levels.", download: "/downloads/usdx-5000-aff-070.xlsx", downloadName: "USDX 5000 AFF 0.70.xlsx", pdf: "/downloads/USDX5000_INSTRUCTIONS.pdf", pdfName: "USDX5000_INSTRUCTIONS.pdf", steps: fiveThousand, graph: fiveThousandActions.map((_, index) => Math.min(5, Math.max(1, Math.ceil((index + 1) / 7)))) },
};
